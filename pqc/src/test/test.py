...
def build_liboqs():
    ...
    os.chdir("..")
    # os.system("cd ..")
    os.system("cmake -S . -B _build && cmake --build _build && cmake --install _build")
    os.chdir("..")
    # os.system("cd ..")
def build_oqs_provider():
    os.chdir("oqs-provider")
    # os.system("cd oqs-provider")
...
if __name__ == "__main__":
    ...
    # test_alg    = "p256_mldsa44"
    # test_cert(test_alg=test_alg)
    # rm_certs(test_alg=test_alg)
    
    test_alg    = "p256_falcon512k"
    test_cert(test_alg=test_alg)
    rm_certs(test_alg=test_alg)
