...
const int16_t PQCLEAN_FALCONPADDED512_KBL_AARCH64_qmvq[8] = {FALCON_Q, FALCON_QINV,
                                                         FALCON_MONT, FALCON_NINV_MONT,
                                                         FALCON_V, 0,
                                                         FALCON_MONT_BR, FALCON_NINV_MONT_BR
                                                        };

const int16_t PQCLEAN_FALCONPADDED512_KBL_AARCH64_ntt_br[] = {
...
const int16_t PQCLEAN_FALCONPADDED512_KBL_AARCH64_ntt_qinv_br[] = {
...
const int16_t PQCLEAN_FALCONPADDED512_KBL_AARCH64_invntt_br[] = {
...
const int16_t PQCLEAN_FALCONPADDED512_KBL_AARCH64_invntt_qinv_br[] = {
