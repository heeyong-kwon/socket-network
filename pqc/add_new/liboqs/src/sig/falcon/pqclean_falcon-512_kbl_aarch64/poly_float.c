...
/* see inner.h */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_add(fpr *c, const fpr *restrict a,
 ...
 * c = a - b
 */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_sub(fpr *c, const fpr *restrict a,
                                        const fpr *restrict b, unsigned logn) {
    float64x2x4_t neon_a, neon_b, neon_c;
    float64x2x2_t neon_a2, neon_b2, neon_c2;
    const unsigned falcon_n = 1 << logn;
 ...
 * c = -a
 */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_neg(fpr *c, const fpr *restrict a,
                                        unsigned logn) {
...
/* see inner.h */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_adj_fft(fpr *c, const fpr *restrict a,
        unsigned logn) {
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_log1(
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_log2(
    fpr *restrict c, const fpr *restrict a, const fpr *restrict b) {
    // n = 4
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_log3(
    fpr *restrict c, const fpr *restrict a, const fpr *restrict b) {
    // n = 8
    float64x2x4_t neon_a, neon_b, neon_c;
 ...
 * c = a * b
 */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft(fpr *c, const fpr *a,
    ...
    switch (logn) {
    case 1:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_log1(c, a, b);
        break;

    case 2:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_log2(c, a, b);
        break;

    case 3:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_log3(c, a, b);
        break;
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_add_log1(
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_add_log2(
    fpr *restrict c, const fpr *restrict d, const fpr *restrict a,
    const fpr *restrict b) {
    // n = 4
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_add_log3(
    fpr *restrict c, const fpr *restrict d, const fpr *restrict a,
    const fpr *restrict b) {
    // n = 8
 ...
 * c = d + a * b
 */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_add_fft(fpr *c, const fpr *restrict d,
        const fpr *a,
        const fpr *restrict b,
        unsigned logn) {
    // Total 32 registers
    ...
    switch (logn) {
    case 1:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_add_log1(c, d, a, b);
        break;

    case 2:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_add_log2(c, d, a, b);
        break;

    case 3:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_fft_add_log3(c, d, a, b);
        break;
...
/* see inner.h */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_muladj_fft(fpr *d, fpr *a,
        const fpr *restrict b,
        unsigned logn) {
...
// c = d + a*b
void PQCLEAN_FALCON512_KBL_AARCH64_poly_muladj_add_fft(fpr *c, fpr *d, const fpr *a,
        const fpr *restrict b,
        unsigned logn) {
 ...
 * c = a * adj(a)
 */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_mulselfadj_fft(fpr *c,
 ...
 * c = d + a * adj(a)
 */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_mulselfadj_add_fft(fpr *c,
 ...
 * c = a * scalar_x
 */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_mulconst(fpr *c, const fpr *a, const fpr x,
        unsigned logn) {
    // assert(logn >= 3);
...
void PQCLEAN_FALCON512_KBL_AARCH64_poly_div_fft(fpr *restrict c,
        const fpr *restrict a,
        const fpr *restrict b,
        unsigned logn) {
...
/* see inner.h */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_add_muladj_fft(
...
/* see inner.h */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_mul_autoadj_fft(fpr *c, const fpr *a,
        const fpr *restrict b,
        unsigned logn) {
    const unsigned falcon_n = 1 << logn;
    const unsigned hn = falcon_n >> 1;
...
/* see inner.h */
void PQCLEAN_FALCON512_KBL_AARCH64_poly_div_autoadj_fft(fpr *c, const fpr *a,
        const fpr *restrict b,
        unsigned logn) {
    const unsigned falcon_n = 1 << logn;
    const unsigned hn = falcon_n >> 1;
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDL_fft_log1(
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDL_fft_log2(
    const fpr *restrict g00, fpr *restrict g01, fpr *restrict g11) {
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDL_fft_log3(
    const fpr *restrict g00, fpr *restrict g01, fpr *restrict g11) {
...
void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDL_fft(const fpr *restrict g00,
    ...
    switch (logn) {
    case 1:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_LDL_fft_log1(g00, g01, g11);

        break;

    case 2:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_LDL_fft_log2(g00, g01, g11);

        break;

    case 3:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_LDL_fft_log3(g00, g01, g11);
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDLmv_fft_log1(
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDLmv_fft_log2(
    fpr *restrict d11, fpr *restrict l10, const fpr *restrict g00,
    const fpr *restrict g01, const fpr *restrict g11) {
    float64x2x4_t g00_re, g00_im, g01_re, g01_im, g11_re, g11_im;
    float64x2x4_t mu_re, mu_im, m, d_re, d_im;
...
static inline void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDLmv_fft_log3(
    fpr *restrict d11, fpr *restrict l10, const fpr *restrict g00,
    const fpr *restrict g01, const fpr *restrict g11) {
    float64x2x4_t g00_re, g00_im, g01_re, g01_im, g11_re;
    float64x2x4_t mu_re, mu_im, m, d_re;
...
void PQCLEAN_FALCON512_KBL_AARCH64_poly_LDLmv_fft(
    fpr *restrict d11, fpr *restrict l10, const fpr *restrict g00,
    ...
    switch (logn) {
    case 1:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_LDLmv_fft_log1(d11, l10, g00, g01, g11);
        break;

    case 2:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_LDLmv_fft_log2(d11, l10, g00, g01, g11);
        break;

    case 3:
        PQCLEAN_FALCON512_KBL_AARCH64_poly_LDLmv_fft_log3(d11, l10, g00, g01, g11);
        break;
...
void PQCLEAN_FALCON512_KBL_AARCH64_poly_fpr_of_s16(fpr *t0, const uint16_t *hm,
