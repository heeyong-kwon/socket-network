...
void PQCLEAN_FALCONPADDED1024_BH_AARCH64_poly_ntt(int16_t a[FALCON_N], ntt_domain_t mont) {
    ...
    const int16_t *ptr_ntt_br = PQCLEAN_FALCONPADDED1024_BH_AARCH64_ntt_br;
    const int16_t *ptr_ntt_qinv_br = PQCLEAN_FALCONPADDED1024_BH_AARCH64_ntt_qinv_br;

    neon_qmvq = vld1q_s16(PQCLEAN_FALCONPADDED1024_BH_AARCH64_qmvq);
...
void PQCLEAN_FALCONPADDED1024_BH_AARCH64_poly_invntt(int16_t a[FALCON_N], invntt_domain_t ninv) {
    ...
    int16x8x2_t zlh, zhh;       // 4
    int16x8_t neon_qmvq;        // 1
    const int16_t *ptr_invntt_br = PQCLEAN_FALCONPADDED1024_BH_AARCH64_invntt_br;
    const int16_t *ptr_invntt_qinv_br = PQCLEAN_FALCONPADDED1024_BH_AARCH64_invntt_qinv_br;
