#ifndef PQCLEAN_FALCON512_BH_AARCH64_API_H
#define PQCLEAN_FALCON512_BH_AARCH64_API_H

#include <stddef.h>
#include <stdint.h>

#define PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_SECRETKEYBYTES   1281
#define PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_PUBLICKEYBYTES   897
#define PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_BYTES            752

#define PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_ALGNAME          "Falcon-512_bh"

#define PQCLEAN_FALCONPADDED512_BH_AARCH64_CRYPTO_BYTES      666 // used in signature verification

/*
 * Generate a new key pair. Public key goes into pk[], private key in sk[].
 * Key sizes are exact (in bytes):
 *   public (pk): PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_PUBLICKEYBYTES
 *   private (sk): PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_SECRETKEYBYTES
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_BH_AARCH64_crypto_sign_keypair(
 ...
 * (in bytes) is PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_BYTES.
 *
 * sig[], m[] and sk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_BH_AARCH64_crypto_sign_signature(
 ...
 * (mlen) by up to PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_BYTES.
 *
 ...
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON512_BH_AARCH64_crypto_sign(
 ...
 * may range up to PQCLEAN_FALCON512_BH_AARCH64_CRYPTO_BYTES.
 *
