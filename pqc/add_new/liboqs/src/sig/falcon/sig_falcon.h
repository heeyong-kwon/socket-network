...
#define OQS_SIG_falcon_512k_length_public_key 897
#define OQS_SIG_falcon_512k_length_secret_key 1281
#define OQS_SIG_falcon_512k_length_signature 752
...
OQS_API OQS_STATUS OQS_SIG_falcon_512k_sign_with_ctx_str(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len, const uint8_t *ctx, size_t ctxlen, const uint8_t *secret_key);
OQS_API OQS_STATUS OQS_SIG_falcon_512k_verify_with_ctx_str(const uint8_t *message, size_t message_len, const uint8_t *signature, size_t signature_len, const uint8_t *ctx, size_t ctxlen, const uint8_t *public_key);
#endif
