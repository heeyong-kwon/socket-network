 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_FFT_log2(fpr *f) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_FFT_log3(fpr *f) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_FFT_log4(fpr *f) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_FFT_log5(fpr *f, const unsigned logn) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_FFT_logn1(fpr *f, const unsigned logn) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_FFT_logn2(fpr *f, const unsigned logn, const unsigned level) {
    const unsigned int falcon_n = 1 << logn;
    const unsigned int hn = falcon_n >> 1;
 ...
 * Note: The scalar version is faster than vectorized code.
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log2(fpr *f) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log3(fpr *f) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log4(fpr *f) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log5(fpr *f, const unsigned logn, const unsigned last) {
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_iFFT_logn1(fpr *f, const unsigned logn, const unsigned last) {
    // Total SIMD register 26 = 24 + 2
 ...
 */
static void PQCLEAN_KBL_FALCON512_AARCH64_iFFT_logn2(fpr *f, const unsigned logn, const unsigned level, unsigned last) {
    const unsigned int falcon_n = 1 << logn;
    const unsigned int hn = falcon_n >> 1;
 ...
 */
void PQCLEAN_KBL_FALCON512_AARCH64_FFT(fpr *f, const unsigned logn) {
    unsigned level = logn;
    switch (logn) {
    case 2:
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_log2(f);
        break;

    case 3:
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_log3(f);
        break;

    case 4:
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_log4(f);
        break;

    case 5:
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_log5(f, 5);
        break;

    case 6:
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_logn1(f, logn);
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_log5(f, logn);
        break;

    case 7:
    case 9:
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_logn2(f, logn, level);
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_log5(f, logn);
        break;
    ...
    case 10:
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_logn1(f, logn);
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_logn2(f, logn, level - 1);
        PQCLEAN_KBL_FALCON512_AARCH64_FFT_log5(f, logn);
        break;
 ...
 * Can be easily extended to logn > 10
 */
void PQCLEAN_KBL_FALCON512_AARCH64_iFFT(fpr *f, const unsigned logn) {
    const unsigned level = (logn - 5) & 1;

    switch (logn) {
    case 2:
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log2(f);
        break;

    case 3:
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log3(f);
        break;

    case 4:
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log4(f);
        break;

    case 5:
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log5(f, 5, 1);
        break;

    case 6:
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log5(f, logn, 0);
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_logn1(f, logn, 1);
        break;

    case 7:
    case 9:
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log5(f, logn, 0);
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_logn2(f, logn, level, 1);
        break;

    case 8:
    case 10:
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_log5(f, logn, 0);
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_logn2(f, logn, level, 0);
        PQCLEAN_KBL_FALCON512_AARCH64_iFFT_logn1(f, logn, 1);
        break;
