#ifndef PQCLEAN_KBL_FALCON512_AARCH64_API_H
#define PQCLEAN_KBL_FALCON512_AARCH64_API_H

#include <stddef.h>
#include <stdint.h>

#define PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_SECRETKEYBYTES   1281
#define PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_PUBLICKEYBYTES   897
#define PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_BYTES            752

#define PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_ALGNAME          "KBL-Falcon-512"

#define PQCLEAN_KBL_FALCONPADDED512_AARCH64_CRYPTO_BYTES      666 // used in signature verification

/*
 * Generate a new key pair. Public key goes into pk[], private key in sk[].
 * Key sizes are exact (in bytes):
 *   public (pk): PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_PUBLICKEYBYTES
 *   private (sk): PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_SECRETKEYBYTES
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_KBL_FALCON512_AARCH64_crypto_sign_keypair(
 ...
 * (in bytes) is PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_BYTES.
 *
 * sig[], m[] and sk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_KBL_FALCON512_AARCH64_crypto_sign_signature(
 ...
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_KBL_FALCON512_AARCH64_crypto_sign_verify(
 ...
 * (mlen) by up to PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_BYTES.
 *
 ...
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_KBL_FALCON512_AARCH64_crypto_sign(
 ...
 * may range up to PQCLEAN_KBL_FALCON512_AARCH64_CRYPTO_BYTES.
 *
 * m[], sm[] and pk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_KBL_FALCON512_AARCH64_crypto_sign_open(
