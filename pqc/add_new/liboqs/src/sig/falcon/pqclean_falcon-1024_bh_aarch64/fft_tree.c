 ...
 */
static inline void PQCLEAN_FALCON1024_BH_AARCH64_poly_mergeFFT_log2(fpr *f, const fpr *f0, const fpr *f1) {
 ...
 */
static inline void PQCLEAN_FALCON1024_BH_AARCH64_poly_mergeFFT_log3(fpr *f, const fpr *f0, const fpr *f1) {
 ...
 */
static inline void PQCLEAN_FALCON1024_BH_AARCH64_poly_mergeFFT_log4(fpr *f, const fpr *f0, const fpr *f1, const unsigned logn) {
 ...
 */
static void
PQCLEAN_FALCON1024_BH_AARCH64_poly_splitFFT_log2(fpr *restrict f0, fpr *restrict f1, const fpr *restrict f) {
    fpr a_re, a_im, b_re, b_im, d_re, d_im, s;
    a_re = f[0];
    b_re = f[1];
    a_im = f[2];
 ...
 */
static inline void PQCLEAN_FALCON1024_BH_AARCH64_poly_splitFFT_log3(fpr *f0, fpr *f1, const fpr *f) {
 ...
 */
static inline void PQCLEAN_FALCON1024_BH_AARCH64_poly_splitFFT_log4(fpr *f0, fpr *f1, const fpr *f, const unsigned logn) {
    const unsigned n = 1 << logn;
 ...
 */
void PQCLEAN_FALCON1024_BH_AARCH64_poly_split_fft(fpr *restrict f0, fpr *restrict f1, const fpr *f, const unsigned logn) {
    switch (logn) {
    case 1:
        //  n = 2; hn = 1; qn = 0;
        f0[0] = f[0];
    ...
    case 2:
        PQCLEAN_FALCON1024_BH_AARCH64_poly_splitFFT_log2(f0, f1, f);
        break;

    case 3:
        PQCLEAN_FALCON1024_BH_AARCH64_poly_splitFFT_log3(f0, f1, f);
        break;

    default:
        PQCLEAN_FALCON1024_BH_AARCH64_poly_splitFFT_log4(f0, f1, f, logn);
        break;
    }
}
 ...
 */
void PQCLEAN_FALCON1024_BH_AARCH64_poly_merge_fft(fpr *restrict f, const fpr *restrict f0,
    ...
    case 2:
        PQCLEAN_FALCON1024_BH_AARCH64_poly_mergeFFT_log2(f, f0, f1);
        break;

    case 3:
        PQCLEAN_FALCON1024_BH_AARCH64_poly_mergeFFT_log3(f, f0, f1);
        break;

    default:
        PQCLEAN_FALCON1024_BH_AARCH64_poly_mergeFFT_log4(f, f0, f1, logn);
        break;
    }
}
